...
export default async function handler(req, res) {
      ...
      try {
              ...
              // Stap 1: probeer de gebruiker toe te voegen aan de server met de Client-rol.
              // Werkt voor nieuwe leden. Retourneert 201 (toegevoegd) of 204 (was al lid).
              ...
              // Stap 2: wijs de rol sowieso ook expliciet toe.
              // Dit is de garantie voor bestaande leden (stap 1 update soms geen rollen
              // voor mensen die al lid waren van de server).
